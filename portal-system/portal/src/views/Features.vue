...
const modules = [
  ...
  },
  {
    ...
    en: 'MedComm Creator',
    cn: '科普内容创作助手',
    desc: '面向多平台（微信公众号、知乎、小红书等）的专业科普内容创作工具。支持一键生成全文并实时流式预览，内置去AI化多轮改写引擎自动降低AIGC检测率，配合段落级AIGC检测精准定位问题段落。通过模板库管理章节结构，富文本编辑器支持自动保存与手动保存，最终可导出 Word、HTML、Markdown 等多种格式，参考文献在导出时从文献绑定面板自动附加。',
    features: [
      '一键生成全文 + 流式实时预览',
      '去AI化多轮改写，自动降低AIGC检测率',
      'AIGC段落级检测与问题定位',
      '模板库管理：自定义章节结构与配置预设',
      '富文本编辑器：自动保存 + 手动保存',
      '多格式导出（Word / HTML / Markdown / 纯文本）',
      '参考文献自动绑定与导出附加',
      'AI写作面板：改写、润色、扩写、缩写',
      '多平台风格适配（微信 / 知乎 / 小红书）',
    ],
